...
export const reducer = createReducer<ProjectState>(
  ...
  on(ProjectActions.loadFailure, (state, { error }) => ({
    ...state,
    error,
    loading: false,
  })),
  ...
  on(ProjectActions.createFailure, (state, { error }) => ({
    ...state,
    error,
    loading: false,
  })),
  ...
  on(ProjectActions.updateFailure, (state, { error }) => ({
    ...state,
    error,
    loading: false,
  })),
  ...
  on(ProjectActions.projectsAdded, (state, { projects }) =>
  ...
  on(ProjectActions.projectRemoved, (state, { project }) =>
